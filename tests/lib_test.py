...
import os
import skin_lesion_detection
import pandas as pd
# Import from our lib
from skin_lesion_detection.lib import clean_data
import pytest


def test_clean_data():
    datapath = os.path.dirname(os.path.abspath(skin_lesion_detection.__file__)) + '/data'
